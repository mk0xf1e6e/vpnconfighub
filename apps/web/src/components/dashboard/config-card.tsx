...
export function ConfigCard({ configured = false }: { configured?: boolean }) {
  return (
    <div className="rounded-2xl border border-[#2b394a] bg-[#242f3d] p-5 shadow-lg">
      ...
      <div className="mt-3 overflow-hidden rounded-xl border border-[#2b394a] bg-[#1f2936] p-3 font-mono text-xs text-[#7f8c99]">
         <p className="text-[#7f8c99]">{configured ? "Configuration details unavailable." : "No configuration available. Provisioning is not connected."}</p>
      </div>
